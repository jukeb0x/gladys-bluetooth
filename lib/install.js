...
var sentences = require('./lib/cometblue/shared.js');
...
module.exports = function () {
  console.log('Bluetooth module: Setting-up devices...');
        return bluetoothScan().then((peripheralMap) => {
          ...
          return gladys.answer.create(sentences.answerCometFr).then(() => {
            console.log("Bluetooth module: Réponse ajoutée");
          }).catch((error) => {
            console.log("Bluetooth module:" + error);
          });
