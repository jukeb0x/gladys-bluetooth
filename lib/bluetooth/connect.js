...
console.log('Awox module => connectable :'+peripheral.connectable+' et addressTYpe '+peripheral.addressType);

  return new Promise((resolve, reject) => {
    if (peripheral.state === 'connected') {
      return resolve(peripheral);
    } else if (peripheral.connectable && ( peripheral.addressType === 'public' || peripheral.addressType === 'random')) {
